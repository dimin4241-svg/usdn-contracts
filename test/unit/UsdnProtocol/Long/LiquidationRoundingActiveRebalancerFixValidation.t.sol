...
contract TestLiquidationRoundingActiveRebalancerFixValidation is UsdnProtocolBaseFixture {
    ...
    function setUp() public {
        ...
        // Remove the initialize-created bootstrap position and reset the accounting price.
        _waitDelay();
        _waitDelay();
        ...
        // Build the same fully post-bootstrap ordinary-position witness.
        ...
        // Seed the real Rebalancer through its public initiate/validate lifecycle. We validate
        // during the same two waits used by the original witness, so the final funding timestamp
        // and whole-dollar rounding counterexample remain unchanged.
